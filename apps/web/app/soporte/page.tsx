...
export const metadata: Metadata = {
  ...
  description:
    'Centro de ayuda y soporte de UrbanFix para consultas técnicas, comerciales y operativas relacionadas con la plataforma.',
...
const supportChannels = [
  ...
  },
  {
    ...
    note: 'Canal rápido para resolver bloqueos o coordinar asistencia.',
  },
];
          ...
          <section className="rounded-3xl border border-white/15 bg-white/[0.03] p-6 sm:p-8">
            ...
            <div className="mt-3 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-white/80 sm:text-base">
                  Si tienes un problema técnico, operativo o comercial con UrbanFix, aquí están los canales
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                ...
                <p className="mt-2 text-lg font-semibold text-white">Técnica y operativa</p>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                ...
                <p className="mt-2 text-sm text-white/70">Escalado formal por correo o soporte rápido por mensaje.</p>
              </div>

              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4">
                <p className="text-[11px] uppercase tracking-[0.2em] text-white/50">Consejo</p>
                <p className="mt-2 text-lg font-semibold text-white">Envía contexto</p>
                <p className="mt-2 text-sm text-white/70">Incluye capturas, ruta afectada y descripción breve del problema.</p>
              </div>
            </div>
          </section>
