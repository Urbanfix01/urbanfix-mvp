  ...
  return (
    <div className={sora.className}>
      ...
      <a
        ...
        className="fixed bottom-4 left-4 z-[60] flex items-center gap-3 rounded-full border border-white/12 bg-[#1b0a29]/92 px-3 py-3 text-white shadow-[0_18px_50px_rgba(0,0,0,0.35)] backdrop-blur-md transition hover:-translate-y-0.5 hover:bg-[#241138] sm:bottom-6 sm:left-6 sm:px-4"
      >
