...
export type HomeViewId = (typeof homepageViewInputs)[number];

const faqJsonLdWithMainEntity = {
  ...faqJsonLd,
  'view-tech',
...
export default function HomePage() {
  return (
    <div className={bodyFont.className}>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(faqJsonLdWithMainEntity) }}
      />
      <script
        type="application/ld+json"
          ...
          <main className="fx-page home-main relative mx-auto w-full max-w-7xl px-6 py-10 md:py-12">
            ...
            <div id="vista-principal" className="home-view-zone view-zone mt-8">
              <section className="home-hero-pane view-pane view-pane--tech grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                <div className="flex flex-col rounded-[34px] border border-slate-200 bg-white p-8 shadow-sm lg:p-10">
                  ...
                  <h1 className={`${displayFont.className} mt-4 text-4xl font-bold leading-tight text-slate-900 sm:text-6xl`}>
              ...
              <section className="home-hero-pane view-pane view-pane--biz grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                <div className="flex flex-col rounded-[34px] border border-slate-200 bg-white p-8 shadow-sm lg:p-10">
                  ...
                  <h2 className={`${displayFont.className} mt-4 text-4xl font-bold leading-tight text-slate-900 sm:text-6xl`}>
