          ...
          <div className="max-w-xl space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <button
                type="button"
                disabled
                className="flex items-center justify-center gap-2 rounded-full bg-[#F97316] px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-orange-500/30 opacity-90"
              >
